...
import at.jku.se.eclipse.emf.ecore.change.Change;
import at.jku.se.eclipse.emf.ecore.change.ChangeDescription;
import at.jku.se.eclipse.emf.ecore.change.ChangeFactory;
import at.jku.se.eclipse.emf.ecore.change.ChangeKind;
import at.jku.se.eclipse.emf.ecore.change.ChangePackage;
import at.jku.se.eclipse.emf.ecore.change.ClassName;
import at.jku.se.eclipse.emf.ecore.change.FeatureChange;
import at.jku.se.eclipse.emf.ecore.change.FeatureMapEntry;
...
public class ChangePackageImpl extends EPackageImpl implements ChangePackage
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see at.jku.se.eclipse.emf.ecore.change.ChangePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
  ...
  /**
	 ...
	 * @generated
	 */
	public EAttribute getEObjectToChangesMapEntry_ClassName() {
		return (EAttribute)eObjectToChangesMapEntryEClass.getEStructuralFeatures().get(2);
	}
  ...
  /**
	 ...
	 * @generated
	 */
	public EAttribute getChange_TimeStamp() {
  ...
  public void createPackageContents()
  {
		...
		createEAttribute(eObjectToChangesMapEntryEClass, EOBJECT_TO_CHANGES_MAP_ENTRY__CLASS_NAME);
		...
		createEAttribute(changeEClass, CHANGE__TIME_STAMP);
  ...
  public void initializePackageContents()
  {
		...
		resourceChangeEClass.getESuperTypes().add(this.getChange());
		...
		initEAttribute(getEObjectToChangesMapEntry_ClassName(), theEcorePackage.getEString(), "className", null, 0, 1, Map.Entry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getChange_TimeStamp(), theEcorePackage.getELong(), "timeStamp", null, 0, 1, Change.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
